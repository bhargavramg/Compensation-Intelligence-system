        ...
        <div className="flex flex-col items-center text-center space-y-12 py-12">
          ...
          <section className="space-y-8 max-w-3xl">
            <div className="space-y-6">
              <h1 className="text-[48px] sm:text-[64px] font-bold leading-[1.05] tracking-tight text-white font-display">
            ...
            <div className="flex items-center justify-center gap-4">
              <button
                ...
                className="px-8 py-3.5 rounded-xl font-bold text-base text-white bg-indigo-500 hover:bg-indigo-400 transition-all active:scale-[0.98] shadow-2xl shadow-indigo-500/20"
              >
                Browse Salaries
              </button>
              <Link 
                href="/submit"
                className="px-8 py-3.5 rounded-xl font-bold text-base text-gray-300 border border-white/10 hover:bg-white/5 transition-all active:scale-[0.98]"
              >
                Submit Salary
              </Link>
            </div>

            <div className="flex items-center justify-center gap-16 pt-8 border-t border-white/5">
              {[
                ...
                <div key={stat.label} className="space-y-1">
                  ...
                  <div className="text-gray-500 text-[11px] uppercase font-bold tracking-[0.2em]">{stat.label}</div>
                </div>
              ))}
            </div>
          </section>
